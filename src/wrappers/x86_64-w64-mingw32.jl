# Autogenerated wrapper script for c_dependent_jll for x86_64-w64-mingw32
export libdependent, deppy
...
const libdependent_splitpath = ["bin", "libdependent.dll"]
...
const libdependent = "libdependent.dll"


# Relative path to `deppy`
const deppy_splitpath = ["bin", "deppy.exe"]
...
function __init__()
    ...
    append!(PATH_list, c_simple_jll.PATH_list)
    append!(LIBPATH_list, c_simple_jll.LIBPATH_list)
